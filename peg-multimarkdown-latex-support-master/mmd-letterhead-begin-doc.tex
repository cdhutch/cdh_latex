...
\ifx\craigsignature\undefined
	\def\signature{~ \\ Greasily,\\
	\ifx\graphicsignature\undefined
	\else
		\resizebox{2in}{!}{\includegraphics{signature.pdf}}\\
	\fi
\justauthor}
\else
	\ifx\graphicsignature\undefined
		...
		\\}
	\else
		\def\signature{\resizebox{2in}{!}{\includegraphics{signature.pdf}}\\
		\craigsignature}
	\fi
\fi
% \ifx\
% \ifx\graphicsignature\undefined
% 	\def\graphicsignature{\resizebox{2in}{!}{\includegraphics{signature.pdf}}}\\
% \else
% \fi
...
% \begin{minipage}[l][\logoheight]{1in}
% 	\coverlogo
% 	\vspace*{\fill}
% \end{minipage} 
% \hfill 
% \begin{minipage}[r][\logoheight]{1in} 
% 	{\renewcommand{\baselinestretch}{1.1}
